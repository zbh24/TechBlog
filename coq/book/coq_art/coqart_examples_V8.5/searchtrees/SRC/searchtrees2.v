...
Hint Resolve min_leaf min_bnode : searchtrees.
...
Hint Resolve maj_leaf maj_bnode : searchtrees.
...
Proof.
 ...
 apply min_bnode.
 apply IHt1. 
 intros; apply H; eauto with searchtrees.
...
Proof.
 ...
 inversion_clear 1.
 eauto with searchtrees.
 apply min_less with (Z_bnode z0 t1 t2).
 eauto with searchtrees.
 trivial. 
  apply min_less with (Z_bnode z0 t1 t2).
 eauto with searchtrees.
