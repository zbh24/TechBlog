...
Section abstract_refl.
 Variable T : Set.
 Definition f (x:T) := true.
 Variable C : T->Prop.
 Variable x : T.
 Variable f_correct : forall x:T, f x = true -> C x.

Check (fun t:T => f_correct t (refl_equal true):C t).
End abstract_refl.
...
Proof.
 ...
 intros p Hd; elim p.
 unfold Zabs_nat.
 intros p' Hrec; rewrite nat_of_P_xI.
 rewrite inj_S.
 rewrite inj_mult.
 rewrite Zpos_xI.
 unfold Zsucc.
