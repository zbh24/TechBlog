...
idtac "#> NatList.count".
check_type @NatList.count (forall (v : nat), forall (s : bag),  nat).
idtac "Assumptions:".
Abort.
...
idtac "#> NatList.add".
check_type @NatList.add (forall (v : nat), forall (s : bag),  bag).
idtac "Assumptions:".
Abort.
...
check_type @NatList.member (forall (v : nat), forall (s : bag),  bool).
idtac "Assumptions:".
Abort.
...
check_type @NatList.beq_natlist_refl (forall l:natlist,  true = beq_natlist l l).
idtac "Assumptions:".
Abort.
