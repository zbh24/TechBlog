...
idtac "#> nandb".
check_type @nandb (forall (b1 : bool), forall (b2 : bool),  bool).
idtac "Assumptions:".
Abort.
...
idtac "#> andb3".
check_type @andb3 (forall (b1 : bool), forall (b2 : bool), forall (b3 : bool),  bool).
idtac "Assumptions:".
Abort.
...
check_type @andb_true_elim2 (forall b c : bool,  andb b c = true -> c = true).
idtac "Assumptions:".
Abort.
