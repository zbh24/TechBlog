...
Definition sum : bag -> bag -> bag := fun (f1 f2:natlist) => app f1 f2.
...
Theorem bag_theorem : forall n , S O = count n (add n nil).
  (* FILL IN HERE *) 
(* FILL IN HERE *)
Proof.
intros.
...
Lemma rev_app :forall l n, rev( l ++ [n]) = n :: rev l.
Proof. 
induction l;intros.
simpl.
reflexivity.
...
Lemma app_assoc2: forall n l1 l2,  n::l1 ++ l2 = n :: (l1 ++ l2).
Proof.
induction l1;intros.
simpl.
reflexivity.
...
Lemma app_assoc3:forall l1 l2 l3, l1 ++ l2 ++ l3 = l1 ++ (l2 ++ l3).
Proof.
induction l2;intros.
simpl.
reflexivity.
...
Lemma app_assoc0:forall l1 l2 l3, (l1 ++ l2) ++ l3 = l1 ++ l2 ++ l3.
Proof.
induction l1.
intros.
simpl.
...
Lemma bag_count_sum :forall l1 l2 ,(count 0 l1) + (count 0 l2) = count 0 (sum l1 l2).
Proof.
induction l1.
induction l2.
simpl.
...
Lemma rev_inject: forall l1 l2, rev l1 = rev l2 -> l1 = l2.
Proof.
intros.
